...
class Enemy:
    ...
    def seek_player(self,player_pos,active_actor,active_solid_tile,level_tile_pos):
        ...
        if abs(dx)>1 or abs(dy)>1:
           ...
           self.collision_walk(self.velocity[0],0,active_actor,active_solid_tile,level_tile_pos)
           self.collision_walk(0,self.velocity[1],active_actor,active_solid_tile,level_tile_pos)
    ...
    def collision_walk(self,xvel,yvel,active_actor,active_solid_tile,level_tile_pos):
        collided=0
        ...
        for i in active_solid_tile:
            tile_rect=[level_tile_pos[i][0],level_tile_pos[i][1],tile_width,tile_height]
